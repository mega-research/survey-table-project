...
import { resolveInviteCode } from './contact-invite';
...
// surveyId 는 accessIdentifier 와 함께 실린다 — 응답 페이지가 이 값을 받으면 슬러그·비공개
// 토큰으로 같은 답을 다시 묻는 왕복이 사라진다(accessIdentifier 는 URL 표기용으로 유지).
