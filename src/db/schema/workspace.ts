...
/**
 * 팀 — 설문 소유·접근의 최소 워크스페이스이자 기본 접근 경계 (마이그레이션 0115).
 *
...
/**
 * 팀 공용 설문 그룹 — 정리용 묶음 (마이그레이션 0117, 티켓 12).
 *
...
/**
 * 설문 단위 부여 — 참여자·게스트·실사 통합 (마이그레이션 0119, 티켓 18).
 *
...
/**
 * 실사 업체 — 외주 실사 인력의 소속 경계 (마이그레이션 0120, 티켓 24).
 *
