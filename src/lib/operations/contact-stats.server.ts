...
import { type OperationsDataScope, targetScopeCondition } from './data-scope.server';

/**
 * 설문의 컨택 설정 통계 — 조건부 열 판정의 단일 출처.
 *
 * "설문 설정 기준"(컨택 타겟 존재 여부, 응답 매칭 무관)으로
 * 엑셀 내보내기와 운영 콘솔 응답 목록의 시스템ID 열이
