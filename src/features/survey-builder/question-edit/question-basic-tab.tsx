...
// 이벤트 핸들러 안에서도 같은 이유로 스토어 인스턴스 API 는 모듈 최상위 별칭으로 집는다.
  ...
  return (
    <>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          >
            ...
            {flattenGroupTree(readBuilderGroups()).map(
              ({ group, depth }) => (
          ...
          <Switch
            ...
            onCheckedChange={(checked) => {
              ...
              if (storeQuestion?.choiceGroups?.length) {
                readBuilderState().silentUpdateQuestion(questionId, {
      ...
      <QuestionTableFields
        ...
        tableEditorEpoch={tableEditorEpoch}
      />
