...
import type { HeaderBulkStyle } from '@/features/survey-builder/table-editor/utils/header-style';
import { getGridSpanStyle } from '@/features/question-renderer/utils/table-grid-utils';
