...
import { ChoiceGroupsProvider } from '@/features/question-renderer/cells/choice-groups-context';
    ...
    render(
      <ResponseSourcesProvider sources={previewResponseSources}>
        <ChoiceGroupsProvider value={choiceGroups}>
          <InteractiveCell cell={cell} questionId="q1" rowCells={rows[0]!.cells} />
    ...
    render(
      <ResponseSourcesProvider sources={previewResponseSources}>
        <ChoiceGroupsProvider value={[choiceGroups[0]!]}>
          <InteractiveCell cell={gated} questionId="q1" rowCells={gatedRows[0]!.cells} />
        </ChoiceGroupsProvider>
      </ResponseSourcesProvider>,
    );
