...
import {
  ...
  useSurveyAnchors,
} from '@/features/survey-builder/queries/use-survey-anchors';
import {
  useAttachSurveyDocument,
  useRemoveSurveyDocument,
  useSurveyDocuments,
} from '@/features/survey-builder/queries/use-survey-documents';
import {
  anchorQuestionLabel,
  buildAnchorOutline,
...
import type { NormRect } from '@/features/question-renderer/utils/anchor-geometry';
