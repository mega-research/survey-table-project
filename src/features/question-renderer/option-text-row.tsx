  ...
  return (
    ...
    <label
      ...
      className={cn(
        ...
        'flex min-h-10 w-full min-w-0 cursor-text items-center gap-2 rounded-[10px] border border-gray-200 bg-white py-0.5 pr-0.5 pl-1 transition-colors focus-within:border-blue-400 hover:border-gray-300 focus-within:hover:border-blue-400',
    ...
    >
      ...
      <span
        ...
        className={cn(
          ...
          stacked
            ? 'self-start [overflow-wrap:anywhere] whitespace-normal'
            : 'max-w-[40%] truncate',
