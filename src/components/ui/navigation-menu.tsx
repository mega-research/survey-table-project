...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      // viewport 대신 각 Item 내부에서 자체 absolute positioning (trigger 바로 아래)
      "absolute left-0 top-full z-50 mt-1.5 rounded-md border border-slate-200 bg-white text-slate-900 shadow-lg",
