...
import { DEFAULT_TABLE_ANSWERABLE_CELL_TYPES } from '@/utils/classify-table';
import { findMobileHeaderCell, resolveMobileCellLabel } from '@/utils/mobile-display-cells';
