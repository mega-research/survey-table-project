...
describe('보기 그룹 표 — 행 단위 그룹 카드', () => {
  ...
  const rowsB1: TableRow[] = [
    {
      ...
      label: '얼라이언스',
      cells: [
        { id: 'r1-lbl', content: '1) 얼라이언스 운영\n네트워킹 및 행사 개최', type: 'text', boldFirstLine: true },
        { id: 'know', content: '①', choiceLabel: '알고 있음', type: 'choice_opt', choiceGroupId: 'g1' },
  ...
  function HarnessB1({ initial = {}, errorCellIds }: { initial?: Record<string, unknown>; errorCellIds?: Set<string> }) {
    const [value, setValue] = useState<Record<string, unknown>>(initial);
    return (
      <>
        <InteractiveTableResponse
