...
import { type ClassifiedLeaf, classifyTable } from '@/components/question-renderer/utils/classify-table';
import {
...
import { buildTableRowspanCoverage } from '@/components/question-renderer/utils/table-rowspan-coverage';
