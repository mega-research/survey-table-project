...
import { useColumnSectionMap, useRowGroups } from '@/components/question-renderer/hooks/use-row-groups';
import { useAnswerQuotes, useContactAttrs } from '@/lib/survey/contact-attrs-context';
import { substituteTokens } from '@/lib/survey/substitute-tokens';
import { cn } from '@/lib/utils';
import type { HeaderCell, TableColumn, TableRow } from '@/types/survey';
import { collectMobileLegendLabels } from '@/components/question-renderer/utils/mobile-display-cells';
