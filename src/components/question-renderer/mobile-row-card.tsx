...
import type { useColumnSectionMap } from '@/components/question-renderer/hooks/use-row-groups';
...
import { getAlignmentClasses } from '@/components/question-renderer/utils/table-grid-utils';
