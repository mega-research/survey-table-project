...
// data/responses.ts 의 exportResponsesAsCsv 셀 포맷 회귀 테스트.
// features/.../response-read.service.ts 의 동일 함수와 셀 포맷 로직이 일치해야 한다(두 export 경로 divergence 방지).
...
import { exportResponsesAsCsv } from './responses';
...
describe('data/responses exportResponsesAsCsv 셀 포맷', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
