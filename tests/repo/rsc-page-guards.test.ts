...
const PAGE_GUARD =
  /\b(requireAuth|requireAdminPage|requireSuperadminPage|requireActiveAccount|requireAccountTypePage|assertSurveyConsolePageAccess|assertGuestSurveyPageAccess)\s*\(/;
